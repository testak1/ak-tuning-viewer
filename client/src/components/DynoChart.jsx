      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={chartData}>
            ...
            <YAxis yAxisId="left" label={{ value: 'HK', angle: -90, position: 'insideLeft', fill: '#4B5563' }} stroke="#4B5563" />
            <YAxis yAxisId="right" orientation="right" label={{ value: 'Nm', angle: 90, position: 'insideRight', fill: '#4B5563' }} stroke="#4B5563" />
            ...
            <Line yAxisId="right" type="monotone" dataKey="origNm" name="Original Nm" stroke="#60A5FA" strokeWidth={2} strokeDasharray="5 5" />
            <Line yAxisId="right" type="monotone" dataKey="tunedNm" name="Tuned Nm" stroke="#EF4444" strokeWidth={2} strokeDasharray="5 5" />
          </LineChart>
        </ResponsiveContainer>
      )}
    </div>
